...
import { ArrowRight, Users, Info, Target } from 'lucide-react';
      ...
      <section id="buy" className="py-20 bg-slate-800/50 relative z-10">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <img 
                src="https://i.ibb.co/83Hr2YK/photo-2025-02-21-17-42-09.png" 
                alt="Pump.fun" 
            ...
            >
              <img 
                src="https://i.ibb.co/TXs4RWv/photo-2025-02-21-17-42-09.png" 
                alt="Blum" 
                className="w-12 h-12 mb-4"
              />
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center items-center">
            ...
            <div className="flex gap-4">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="bg-blue-500 hover:bg-blue-600 px-8 py-3 rounded-full transition"
              >
